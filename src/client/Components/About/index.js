  ...
  return (
    <section className="about">
      <div className="about__content">
        ...
        <p>
          This website is powered by the <a className="link" href="https://www.worldweatheronline.com/developer/api/" target="_blank">worldweatheronline</a> historical weather api. 
          <br/>
          ...
          The hourly data is then mapped into six and three hour intervals, respectively, to compare what the weather was like two years ago and one year ago.
          <br/>
          <br/>
